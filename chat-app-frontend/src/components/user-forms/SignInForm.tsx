...
export const SignInFormComponent = () => {
  ...
  const [loginUser] = useLazyQuery(SIGN_IN, {
    onCompleted: (data) => {
      const getToken = data?.signIn?.token?.split(' ')?.[1];
      console.log('$$$____Login Success_____%%%%');
      const decodeJwt: JwtPayloadType = jwtDecode(getToken);
    ...
    <div className="signup-page-container">
      ...
      <div>
        <form
          ...
          onSubmit={handleSubmit(loginFunctionHandler)}
        >
          <div>
            <h2>Sign In</h2>
          </div>
          ...
          <div className="form-action-control">
            ...
            <div>
              <a
                ...
                onClick={registerFunctionHandler}
              >
                Register
              </a>
            </div>

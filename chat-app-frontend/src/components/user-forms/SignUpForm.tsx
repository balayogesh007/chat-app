...
export const SignUpFormComponent = () => {
    ...
    return (
      <div className='signup-page-container'>
        <div className='signup-image-banner'>
        </div>
        <div>
          <form action="" target="blank" className="form-control" onSubmit={handleSubmit(formSubmitHandler)}>
          <div>
            <h2>Register</h2>
          </div>
          ...
          <div className='input-label-container'>
              ...
              <input type="text" placeholder='Email' {...register("emailid", { required: true, pattern: /^[^@ ]+@[^@ ]+\.[^@ .]{2,}$/ })} />
          ...
          <div className='form-action-control'>
            ...
            <a href="" className='register-anchor' onClick={loginFunctionHandler}>Log In</a>
          </div>
        </form>
